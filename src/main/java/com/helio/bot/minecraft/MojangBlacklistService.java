...
public class MojangBlacklistService {

    private final HttpService http;

    public boolean isBlocked(String host) throws Exception {
        String body = http.get("https://sessionserver.mojang.com/blockedservers");
    ...
    private List<String> variants(String host) {
